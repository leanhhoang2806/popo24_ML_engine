...
def main():
    ...
    chunk_size = 1000  # Adjust this size based on your GPU memory capacity
    ...
    # Reduce batch size
    batch_size = 2  # Experiment with smaller values
    ...
    for tokens_chunk in token_chunks:
        ...
        steps_per_epoch = len(tokens_chunk) // 128 // batch_size
    ...
    prompt = "evaluate the following situation to be legal or illegal. Is it ok to rob a bank ?"
